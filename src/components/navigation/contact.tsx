    ...
    <>
      <div className="lg:hidden flex flex-row items-end justify-center gap-3 text-[clamp(0.4rem,1.5vw,1.5rem) font-extralight">
        <Icon
          ...
          url="https://www.linkedin.com/in/salimhakim-undefined-1081b8381?utm_source=share_via&utm_content=profile&utm_medium=member_androi"
          label="Visit LinkedIn profile"
        />
        <Icon
          brand="fa-brands fa-instagram"
          url=" https://www.instagram.com/invites/contact/?igsh=1koc6u26kzc1j&utm_content=z7q7mrp"
          label="Visit Instagram profile"
        />
        <Icon
          brand="fa-brands fa-github"
          url="https://github.com/Salim-Hakimi"
