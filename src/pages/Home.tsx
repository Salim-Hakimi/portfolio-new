      ...
      >
        ...
        <div className="lg:h-[clamp(20rem,60vh,40rem)] flex flex-col items-start justify-end">
          ...
          <div className="w-[80vw] lg:w-[35vw] flex flex-col pt-[5vh] lg:pt-[clamp(1rem,7.5vh,3rem)] text-[clamp(0.7rem,1vw,1.2rem)] tracking-[0.1rem] font-light gap-1 leading-[clamp(1.1rem,3vh,1.4rem)]">
            <p>
              I am currently in my final year of Bachelor of Software
              Engineering at Kabul University.
            </p>
            <p>
              My main focus is web development, and I have worked on several
              full-stack personal projects. I enjoy exploring new technologies
              and experimenting with creative ideas.
            </p>
            <p>
              Outside of programming, I create origami art, play Volleball,
              Footsal, and chess.
            </p>
          </div>
        </div>
          ...
          <div className="mt-[5vh] w-[80vw] lg:w-[75vw] flex flex-col items-start justify-start gap-10 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex flex-col w-[80vw] lg:w-[25vw] gap-3 font-light">
              ...
              <div className="w-full text-[clamp(0.8rem,1.2vw,1rem)] flex flex-wrap gap-2">
                <p
                  className={`w-fit h-fit p-1 px-5 m-1 border border-[#888888aa] rounded-full duration-500 ${theme === "dark" ? "hover:bg-white hover:text-[#101010]" : "hover:bg-black hover:text-[#ffffffcc]"}`}
                >
                  TypeScript
                </p>
                <p
...
function Email() {
  ...
  return (
    <a
      href="mailto:m.salimhakimi123@gmail.com"
      aria-label="Send an email to Salim Hakimi"
      onMouseEnter={() => set("hover")}
      onMouseLeave={() => set("default")}
    >
      m.salimhakimi123@gmail.com
    </a>
  );
}
