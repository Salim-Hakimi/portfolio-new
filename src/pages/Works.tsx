...
const works = [
  {
    ...
    sub: "Personal Project / Full Stack",
    description:
  ...
  },
  {
    ...
    sub: "Personal Project / Full Stack",
    description:
      "My first portfolio, built with WordPress, CSS, and JavaScript.",
  },
  {
    id: 4,
    title: "POLYGON FLOWER",
    sub: "Digital Art",
    description: "Randomly colored and shaped flower built with p5.js",
  },
];
      ...
      >
        <div className="w-[80vw] lg:portrait:w-[35vw] landscape:w-[35vw] h-[15vh] flex flex-row items-end justify-between">
          ...
          <a
            ...
            href="https://github.com/Salim-Hakimi"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="mt-[5vh] lg:portrait:mt-[14vh] landscape:mt-[14vh]">
          <div className="h-auto overflow-hidden flex flex-row items-center text-[clamp(0.7rem,1vw,1.2rem)] lg:text-[clamp(1rem,1.2vw,1.5rem)] font-light tracking-widest mb-4">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                key={focus.id}
                className="w-[clamp(1.5rem,2vw,2.5rem)] lg:w-[clamp(2rem,2.5vw,3rem)] flex flex-row"
              >
                <motion.div
                  initial={{ y: "100%" }}
                  animate={{ y: 0 }}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <h3 className="text-[clamp(0.7rem,1vw,1.2rem)] lg:text-[clamp(1rem,1.2vw,1.5rem)] font-light">
                {focus.sub}
              </h3>
              <p className="text-[clamp(0.7rem,1vw,1.2rem)] lg:text-[clamp(1rem,1.2vw,1.5rem)] font-light mt-5">
                {focus.description}
              </p>
            </motion.div>
          </AnimatePresence>
