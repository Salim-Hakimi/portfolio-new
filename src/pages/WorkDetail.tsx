    ...
    >
      <NavLink to="/Works">
        ...
        >
          <span>
            <svg
              width="clamp(0.6rem,1vw,1.5rem)"
              height="clamp(0.6rem,1vw,1.5rem)"
              viewBox="0 0 37 72"
              fill="none"
            ...
            >
              <line
                ...
                x2="36.0018"
                y2="0.646455"
                stroke={`${theme === "dark" ? "white" : "#101010cc"}`}
                strokeWidth="4"
              />
              <line
                x1="0.353553"
        ...
        >
          <div className="w-[80vw] md:w-[40vw] lg:w-[35vw] flex flex-col gap-5 md:gap-8">
            <div className="flex flex-col items-start justify-between gap-2">
              <h2 className="text-[clamp(1rem,1.5vw,2rem)] md:text-[clamp(1.1rem,2vw,2rem)]">
                TOOLS
              </h2>
              <div className="w-full text-[clamp(0.7rem,1vw,1rem)] landscape:text-[clamp(0.6rem,0.8vw,0.8rem)] lg:portrait:text-[clamp(0.7rem,1vw,1rem)] lg:landscape:text-[clamp(0.7rem,1vw,1rem)] flex flex-wrap gap-1 md:gap-2">
                {data?.techs.map((val, i) => (
                  <p
                    key={i}
                    className={`w-fit h-fit p-[0.15rem] px-[0.8rem] md:p-1 md:px-5 m-1 border border-[#888888aa] rounded-full duration-500 ${theme === "dark" ? "hover:bg-white hover:text-[#101010]" : "hover:bg-black hover:text-[#ffffffcc]"}`}
                  >
                    {val}
                  </p>
                ))}
            ...
            <div className="flex flex-row items-start justify-between">
              <div className="flex flex-col items-start justify-between gap-2">
                ...
                <p className="text-[clamp(0.8rem,1.5vw,1rem)] landscape:text-[clamp(0.7rem,1vw,1.2rem)] lg:portrait:text-[clamp(1rem,1.2vw,1.5rem)] lg:landscape:text-[clamp(1rem,1.2vw,1.5rem)]">
                  {data?.duration}
                </p>
              </div>
          ...
          <div className="w-[80vw] md:w-[35vw] h-full flex flex-col items-start justify-between gap-2 mt-8 md:mt-0">
            ...
            <p className="text-[clamp(0.8rem,1.5vw,1rem)] lg:text-[clamp(1rem,1.2vw,1.5rem)]">
              {data?.summary}
            </p>
